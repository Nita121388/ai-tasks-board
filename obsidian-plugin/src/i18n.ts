...
const STRINGS = {
  ...
  "cmd.open_debug_sidebar": { en: "AI Tasks: Open debug sidebar", zh: "AI Tasks：打开调试侧栏" },
  ...
  "debug.logs.stdout": { en: "sessions.stdout.log", zh: "sessions.stdout.log" },
  "debug.logs.stderr": { en: "sessions.stderr.log", zh: "sessions.stderr.log" },
  "debug.card.runtime": { en: "Runtime", zh: "运行时" },
  "debug.card.watcher": { en: "Watcher", zh: "监听器" },
  "debug.card.session_dir": { en: "Session dir", zh: "会话目录" },
  "debug.card.total": { en: "Total sessions", zh: "累计会话数" },
  "debug.card.today": { en: "Today sessions", zh: "今日会话数" },
  "debug.card.latest": { en: "Latest session", zh: "最新会话" },
  "debug.stage.runtime": { en: "Runtime ready", zh: "运行时就绪" },
  "debug.stage.watcher": { en: "Watcher running", zh: "监听器运行" },
  "debug.stage.poll": { en: "Poll cycle", zh: "轮询周期" },
  "debug.stage.write": { en: "Session write", zh: "会话写入" },
  "debug.stage.link": { en: "Board link", zh: "看板关联" },
  "debug.stage.no_tick": { en: "No polling result yet.", zh: "尚无轮询结果。" },
  "debug.stage.waiting_data": { en: "Waiting for data.", zh: "等待数据中。" },
  "debug.stage.none_new": { en: "No new session in this cycle.", zh: "本轮无新会话。" },
  "debug.stage.failed": { en: "Failed. See stderr/events.", zh: "失败，请查看 stderr/事件。" },
  "debug.stage.wait_stable": { en: "New session exists but still stabilizing.", zh: "有新会话但仍在稳定期。" },
  "debug.stage.skipped_old": { en: "Historical sessions skipped by ignore_before.", zh: "历史会话被 ignore_before 跳过。" },
  "debug.stage.written": { en: "Wrote {{count}} new session file(s).", zh: "已写入 {{count}} 个新会话文件。" },
  "debug.stage.linked": { en: "Linked {{count}} session(s) to tasks.", zh: "已关联 {{count}} 个会话到任务。" },
  "debug.stage.created_unassigned": { en: "Created {{count}} unassigned task(s).", zh: "已创建 {{count}} 个未分配任务。" },
  "debug.stage.no_link_change": { en: "No board link changes this cycle.", zh: "本轮看板无关联变更。" },
  "debug.stage.none": { en: "(none)", zh: "（无）" },
  "debug.stage.no_events": { en: "No events yet.", zh: "暂无事件。" },
  "debug.status.online": { en: "online", zh: "在线" },
  "debug.status.offline": { en: "offline", zh: "离线" },
  "debug.status.running": { en: "running", zh: "运行中" },
  "debug.status.stopped": { en: "stopped", zh: "未运行" },
  "debug.status.exists": { en: "exists", zh: "存在" },
  "debug.status.missing": { en: "missing", zh: "不存在" },
